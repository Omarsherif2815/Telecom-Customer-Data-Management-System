...
AS
    SELECT 
        ...
        SUM(pb.pointsAmount) AS totalPoints
    FROM Payment P
    INNER JOIN Points_group pb ON p.paymentID = pb.paymentId
    WHERE P.mobileNo = @mobile_num 
        AND (YEAR(CURRENT_TIMESTAMP) - YEAR(p.date_of_payment) = 1) 
...
VALUES 
(1, 'John', 'Doe', 'john.doe@example.com', '1234 Elm Street, Cairo', '1990-05-12'),
(2, 'Jane', 'Smith', 'jane.smith@example.com', '5678 Oak Avenue, Cairo', '1985-09-24');
...
VALUES 
('01234567890', 'password123', 100.5, 'postpaid', '2024-01-01', 'active', 50, 1),
('02345678901', 'password456', 200.0, 'prepaid', '2024-02-15', 'onhold', 30, 2);

-- Insert service plans
INSERT INTO Service_plan (name, price, SMS_offered, minutes_offered, data_offered, description)
VALUES 
('Basic Plan', 50, 500, 100, 1000, 'Basic plan with limited benefits'),
('Premium Plan', 100, 1000, 200, 5000, 'Premium plan with more benefits');

-- Insert subscriptions with valid status values
INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES 
('01234567890', 1, '2024-01-01', 'active'),   -- Ensure 'active' is a valid status in the Subscription table
('02345678901', 2, '2024-02-15', 'onhold');   -- Ensure 'onhold' is a valid status in the Subscription table

-- Insert plan usage
INSERT INTO Plan_Usage (start_date, end_date, data_consumption, minutes_used, SMS_sent, mobileNo, planID)
VALUES 
('2024-01-01', '2024-01-31', 200, 50, 100, '01234567890', 1),
('2024-02-01', '2024-02-28', 300, 100, 150, '02345678901', 2);

-- Insert payments with valid payment_method values
INSERT INTO Payment (amount, date_of_payment, payment_method, status, mobileNo)
VALUES 
(50, '2024-01-01', 'cash', 'successful', '01234567890'),  -- Ensure 'cash' is a valid payment method in the Payment table
(100, '2024-02-15', 'credit', 'pending', '02345678901');  -- Ensure 'credit' is a valid payment method in the Payment table

-- Insert process payments (ensure paymentID exists in the Payment table)
-- After inserting valid payments, insert into process_payment using correct paymentID
INSERT INTO process_payment (paymentID, planID)
VALUES 
(1, 1),  -- Insert with valid paymentID values that exist in the Payment table
(2, 2);  -- Insert with valid paymentID values that exist in the Payment table

-- Insert wallet data
INSERT INTO Wallet (current_balance, currency, last_modified_date, nationalID, mobileNo)
VALUES 
(1000.00, 'EGP', '2024-01-01', 1, '01234567890'),
(500.00, 'EGP', '2024-02-15', 2, '02345678901');

-- Insert transfer money data
INSERT INTO transfer_money (walletID1, walletID2, amount, transfer_date)
VALUES 
(1, 2, 50.00, '2024-01-15'),
(2, 1, 100.00, '2024-02-20');

-- Insert benefits with valid status values
INSERT INTO Benefits (description, validity_date, status, mobileNo)
VALUES 
('Free data for a month', '2024-12-31', 'active', '01234567890'),   -- Ensure 'active' is valid status
('Discount on recharge', '2024-06-30', 'expired', '02345678901');   -- Ensure 'expired' is valid status

-- Insert points group data (ensure paymentID exists)
INSERT INTO Points_group (benefitID, pointsAmount, paymentId)
VALUES 
(1, 100, 1),   -- Ensure paymentID 1 exists in Payment table
(2, 50, 2);    -- Ensure paymentID 2 exists in Payment table
...
('Gadget Shop', 'Accessories');

-- Insert physical shop
INSERT INTO Physical_shop (shopID, address, working_hours)
VALUES 
(1, '123 Tech St, Cairo', '9 AM - 9 PM'),
(2, '456 Gadget Rd, Cairo', '10 AM - 8 PM');

-- Insert e-shop
INSERT INTO E_shop (shopID, URL, rating)
VALUES 
(1, 'https://techstore.com', 5),
(2, 'https://gadgetshop.com', 4);

-- Insert vouchers
INSERT INTO Voucher (value, expiry_date, points, mobileNo, redeem_date, shopid)
VALUES 
(50, '2024-12-31', 100, '01234567890', '2024-01-20', 1),
(100, '2024-06-30', 200, '02345678901', '2024-02-10', 2);

-- Insert technical support tickets
INSERT INTO Technical_support_ticket (mobileNo, issue_description, priority_level, status)
VALUES 
('01234567890', 'Network issue', 1, 'Open'),
('02345678901', 'Payment error', 2, 'In progress');

-- Insert more customers
INSERT INTO customer_profile (nationalID, first_name, last_name, email, address, date_of_birth)
VALUES
(3, 'Michael', 'Williams', 'michael.williams@example.com', '321 Pine Street, Cairo', '1982-11-20'),
(4, 'Emily', 'Davis', 'emily.davis@example.com', '654 Maple Avenue, Cairo', '1993-04-10');

-- Insert customer accounts for the new customers
INSERT INTO customer_account (mobileNo, pass, balance, account_type, start_date, status, points, nationalID)
VALUES
('01234567891', 'password789', 150.0, 'postpaid', '2024-07-01', 'active', 25, 3),
('02345678902', 'password101', 120.0, 'prepaid', '2024-08-10', 'onhold', 15, 4);

-- Insert new service plans
INSERT INTO Service_plan (name, price, SMS_offered, minutes_offered, data_offered, description)
VALUES
('Basic Plus', 60, 600, 150, 2000, 'Enhanced plan with more SMS and minutes'),
('Ultimate Plan', 200, 2000, 500, 10000, 'All-inclusive plan for heavy users');

-- Insert new subscriptions with valid status values
INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('01234567891', 3, '2024-07-01', 'active'),
('02345678902', 4, '2024-08-10', 'inactive');  -- Ensure 'inactive' is valid status in the Subscription table

-- Insert new payment records with valid payment_method
INSERT INTO Payment (amount, date_of_payment, payment_method, status, mobileNo)
VALUES
(60, '2024-07-01', 'credit', 'successful', '01234567891'),
(200, '2024-08-10', 'debit', 'pending', '02345678902');

-- Insert new process payments with valid paymentID values
INSERT INTO process_payment (paymentID, planID)
VALUES 
(3, 3),
(4, 4);
...
INSERT INTO customer_account (mobileNo, pass, balance, account_type, start_date, status, points, nationalID)
VALUES 
('01874587805', 'password123', 100.5, 'postpaid', '2024-01-01', 'active', 50, 1),
('02845696702', 'password456', 200.0, 'prepaid', '2024-02-15', 'active', 30, 2);


INSERT INTO Technical_support_ticket (mobileNo, issue_description, priority_level, status)
VALUES 
('01234567890', 'Network issue', 1, 'Resolved');